...
class SpinClass:
    ...
    def __generate_portal_avatar_opponent(self):
        ...
        if portal == avatar or portal == opponent or opponent == avatar:
            return __generate_portal_avatar_opponent()
    ...
    def __generate_all(self):
        ...
        li = self.__generate_portal_avatar_opponent()
        ...
        formatted_init = promela_init.format(self.__generate_walls(), li[0], li[1], li[2], li[3], li[4], li[5])
